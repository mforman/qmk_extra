...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_COLEMAK] = LAYOUT_crkbd_wrapper(
    CW_TOGG, _________________COLEMAK_L1________________,     _________________COLEMAK_R1________________, KC_EQL ,
    OSM_ALT, _________________COLEMAK_L2________________,     _________________COLEMAK_R2________________, OSM_ALT,
    OSM_SFT, _________________COLEMAK_L3________________,     _________________COLEMAK_R3________________, OSM_SFT,
